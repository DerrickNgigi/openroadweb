                            ...
                            <ul>
                                ...
                                <li data-index="rs-100" data-transition="slotfade-vertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000"  data-thumb="images/main-slider/slider1/slide1.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Big &amp; Bold" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    <div class="tp-caption BigBold-Button rev-btn "
                                         ...
                                         style="z-index: 8; "><a href="#" class="site-button">READ MORE</a> </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="mt-box m-b30">
                            <div class="mt-thum-bx mt-img-effect  mt-img-overlay2">
                                <img src="images/background/bg12.jpg" alt="">
                    ...
                    <div class="col-md-7">
                        <div class="mt-box m-b25">
                            <h2 class="display-block m-b15 m-t0">We give you complete control of your shipments.</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="m-b30 text-black mt-icon-box-wraper center bdr-1 bdr-solid bdr-gray-light bg-white p-a20">
                                    <div class="counter font-42 font-weight-800 m-b15 text-primary">45</div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="m-b30 text-black mt-icon-box-wraper center bdr-1 bdr-solid bdr-gray-light bg-white p-a20">
                                    <div class="counter font-42 font-weight-800 m-b15 text-primary">1500</div>
                    ...
                    <div class="container">
                        <div class="section-head text-center">
                            <div class="mt-box  text-white m-b30">
                                <h2 class="m-tb0">Since <span class="text-primary">10 years</span> we are providing you some special services.
                                </h2>
                                <p class="m-b15">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sit amet, consectetur adipiscing elit, sed doeius mod tempor sed do eiusmod</p>
            ...
            <div class="container">
                ...
                <div class="section-content ">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-post latest-blog-1 date-style-2 overflow-hide  bg-white bdr-1 bdr-solid bdr-gray-light m-b30">
                                <div class="mt-post-media">
                                    <img src="images/blog/grid/pic5.jpg" alt="">
                                </div>
                                <div class="mt-post-info  p-a30">
                                    <div class="mt-post-meta text-black bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
                                        <ul>
                                            <li class="post-date"> <i class="fa fa-calendar text-primary"></i><strong>09</strong><span>Oct 2018</span> </li>
                                            <li class="post-author"><i class="fa fa-user text-primary"></i><a href="javascript:void(0);">By <span>John</span></a> </li>
                                            <li class="post-comment"><i class="fa fa-comments text-primary"></i> <a href="javascript:;">14 Comment</a> </li>
                                        </ul>
                                    </div>

                                    <div class="mt-post-title ">
                                        <h4 class="post-title">A partnership based trust.</h4>
                                    </div>
                        ...
                        <!-- Block 2 -->
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-post latest-blog-1 date-style-2 overflow-hide bdr-1 bdr-solid bdr-gray-light  bg-white m-b30">
                                <div class="mt-post-media">
                                    <img src="images/blog/grid/pic6.jpg" alt="">
                                </div>
                                <div class="mt-post-info  p-a30">
                                    <div class="mt-post-meta text-black bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
                                        <ul>
                                            <li class="post-date"> <i class="fa fa-calendar text-primary"></i><strong>15</strong><span>Oct 2018</span> </li>
                                            <li class="post-author"><i class="fa fa-user text-primary"></i><a href="javascript:void(0);">By <span>John</span></a> </li>
                                            <li class="post-comment"><i class="fa fa-comments text-primary"></i> <a href="javascript:;">14 Comment</a> </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="mt-post-title ">
                                        <h4 class="post-title">An anchor in a new era.</h4>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-post latest-blog-1 date-style-2 overflow-hide bdr-1 bdr-solid bdr-gray-light  bg-white m-b30">
                                <div class="mt-post-media">
                                    <img src="images/blog/grid/pic7.jpg" alt="">
                                </div>
                                <div class="mt-post-info  p-a30">
                                    <div class="mt-post-meta text-black bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
                                        <ul>
                                            <li class="post-date"> <i class="fa fa-calendar text-primary"></i><strong>20</strong><span>Oct 2018</span> </li>
                                            <li class="post-author"><i class="fa fa-user text-primary"></i><a href="javascript:void(0);">By <span>John</span></a> </li>
                                            <li class="post-comment"><i class="fa fa-comments text-primary"></i> <a href="javascript:;">14 Comment</a> </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="mt-post-title ">
                                        <h4 class="post-title">Fueling your logistic chain.</h4>
                                    </div>
                        ...
                        <div class="equal-wraper">
                            <div class="col-md-4 col-sm-6">
                                <div class="mt-icon-box-wraper  p-a30 bgcall-block hover-shadow hover-border-outer hover-border m-b30">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="mt-tilte  m-b15 text-primary">Customer Satisfication Tools</h4>
                    ...
                    <div class="owl-carousel home-carousel-1">
                        <div class="item">
                            <div class="testimonial-2  clearfix bg-white">
                                ...
                                <div class="testimonial-text">
                                    <strong class="testimonial-name text-uppercase">Collis Ta'eed </strong>
                        ...
                        <div class="item">
                            <div class="testimonial-2 clearfix bg-white">
                                ...
                                <div class="testimonial-text">
                                    <strong class="testimonial-name text-uppercase">John Doe</strong>
                                    <span class="testimonial-position">Manager</span>
                                    <span class="fa fa-quote-left"></span>
                                    <p> Excellent Customer support!.The template itself is very extended. simply dummy text of the printing and industry.</p>
                                ...
                                <div class="pricingtable-wrapper pricing-table-style-5 pricing-table-shadow">
                                    <div class="pricingtable-inner bg-gray">
                                        ...
                                        <div class="pricingtable-footer">
                                            <a href="javascript:void(0);" class="site-button text-uppercase">Order Now</a>
                                        </div>
